$ ->
	...
	$('#play-button').on 'click', ->
		...
		tl.from('#yeah-1', 0.5, {width:"0px", alpha:0}, 75.530)
		tl.from('#yeah-2', 0.5, {width:"0px", alpha:0}, 77.327)
		...
		tl.staggerFrom(splitText('#barrage-2'), 0.5, {width:"0px", alpha:0}, 0.2, 139.446)
		tl.staggerFrom(splitText('#barrage-3'), 0.5, {width:"0px", alpha:0}, 0.2, 140.492)
		tl.staggerFrom(splitText('#barrage-4'), 0.5, {width:"0px", alpha:0}, 0.2, 140.977)
		tl.staggerFrom(splitText('#barrage-5'), 0.5, {width:"0px", alpha:0}, 0.2, 141.675)
		tl.staggerFrom(splitText('#barrage-6'), 0.5, {width:"0px", alpha:0}, 0.2, 142.650)
		tl.staggerFrom(splitText('#barrage-7'), 0.5, {width:"0px", alpha:0}, 0.2, 143.466)
